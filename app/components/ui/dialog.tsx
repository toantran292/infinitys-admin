  ...
  'fixed z-50 grid w-full gap-4 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 sm:rounded-lg',
  {
    variants: {
      ...
      position: {
        ...
        top: 'left-[50%] top-6 translate-x-[-50%] data-[state=closed]:slide-out-to-top-16 data-[state=open]:slide-in-from-top-16',
      },
      size: {
        default: 'max-w-lg',
        sm: 'max-w-md',
...
const DialogContent = React.forwardRef<
  ...
  DialogContentProps
>(({ className, variant = 'default', size, position, children, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay />
